...
- **37 injects produits** sur 6 séries (07.01 à 08.01)
...
| P.01 — Architecture déni Storm-1516 | **LO 1** (FICTIONNALISATION + DÉCEPTION) | LO 4 |
| P.02 — Piège narratif rétroactif | **LO 1** (DÉCEPTION) | LO 2 |
| P.03 — Bascule politique BR | **LO 5** (RUPTURE) | LO 1 |
| R1 — Contremesures camp bleu | **LO 5** (doute intra-coalition) | LO 2 |
| R4 — Blanchiment BC1 | **LO 1** (DÉCEPTION — blanchiment) | LO 4 |
| R6 — Renforcement dénigrement | **LO 2** (FRAGILITÉ OTAN) | LO 3 |
| R5 — Alerte D+39 nuit | **LO 5** (signaux BR) | LO 3 |
...
- 08.01 → LO 3 · P.01 → LO 1 · P.02 → LO 1 · P.03 → LO 5
- R1 → LO 5 · R6 → LO 2 · Tracts psyops → LO 2 · Courriers → LO 3
