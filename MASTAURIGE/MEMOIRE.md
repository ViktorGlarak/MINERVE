...
| Heure | Inject | Avatar / Canal | Camp | Référence |
|---|---|---|---|---|
| 14h00 | Tract MAF STEP 1 — image jpg | MAF (média) | ROUGE | 07.02.05i |
| 15h00 | Photo tract NEUFCHATEAU — tweet image | @TemoignageDAC | ROUGE | 07.02.06i |
| 18h00 | SMS bombing — @MarionKessler57 partage capture SMS psyops reçu | @MarionKessler57 | **BLEU** ⚠ | 07.02.05i_bis ✅ |
