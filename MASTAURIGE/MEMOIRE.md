...
⚠ **À refiner (utilisateur, « on modifiera au besoin »)** : avatars 2BB nominatifs DAC (`@VoixDACia`, `@TemoignageDAC`) → remapper registre ; tournures mécaniques ; camp TV4=bleu à confirmer.
