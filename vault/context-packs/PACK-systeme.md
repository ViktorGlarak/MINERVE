# 📦 Context-pack — systeme

> ⚙️ Généré (`generer_context_packs.py`). **À charger pour travailler sur « systeme ».**
> Notes triées par tier (1 = prioritaire). Les fichiers `source:` sont la vérité à ouvrir.
> Généré le 2026-06-28 · 6 notes.

## Notes (par tier)

| Tier | ID | Titre | Type |
|---|---|---|---|
| 1 | [ARCH-001](../architecture/ARCH-001.md) | Vault MINERVE — source de vérité unique | architecture |
...
| 3 | [ARCH-007](../architecture/ARCH-007.md) | Roadmap technique MINERVE (RAG · CONVERGENCE · orchestrateur autonome) | architecture |
