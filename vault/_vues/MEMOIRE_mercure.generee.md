# 🤖 MÉMOIRE MERCURE — VUE GÉNÉRÉE

> ⚙️ **Document généré** par `generer_vue_memoire.py` depuis le vault atomique — **ne pas éditer à la main**.
> Démonstration Phase 4 (inversion du flux). La vraie autorité de travail reste `ANALYSTE/MERCURE/MEMOIRE.md` tant que la bascule n'est pas validée.
> Le **camp** de chaque persona provient de **sa note entité** (source unique). Généré le 2026-06-25.

## Carte d'identité

> Autorité doctrinale : **ANALYSTE_MERCURE** (`source:`). ⚠ Le **pays** garde son nom « Mercure » (le SYSTÈME est « MINERVE »). Puissance centrale du [[LESSON-004|GET]]. **Camp 🔴 rouge** (l'agresseur).

## Identité & régime
République **autocratique** ; capitale **HMunik** ; ~69,6 M ; **Président Franz Olamao** au pouvoir depuis 2001 (CINC). Parti unique **MUP** ; Commissariat (cabinet) ; presse 172/180. Défense **8-10 % du PIB**. Triade nucléaire (~4 500 ogives), ~607 000 militaires, milice **TANTALE**.

## Posture & narratif
Anti-OTAN/anti-impérialiste, **nostalgie Skolkan**, « menace extérieure ». Justifie l'intervention par la **R2P** de la diaspora mercurienne (« We are not occupying. We are protecting. » — Olamao). Considère l'**environnement informationnel comme stratégiquement décisif**.

## Leviers
- **Quasi-monopole gazier** Skolkan (Arnland dépend à 63 % ; Nord/Sud Fluss) — chantage énergétique.
- **Diaspora 3,4 M en Arnland** (8 %) → prétexte R2P + vivier **TANTALE**.
- **Appareil ILI** type **Storm-1516** (CPD/SIO, « Mercure Today », « Meracity », ZubrRadio) — voir [[LESSON-001]] et la doctrine OI dans la source.

## Personas
Président [[ENT-olamao]] · agitateurs TANTALE [[ENT-kaleva]] [[ENT-milanov]] · roster complet (gouvernement, FGF-4, renseignement…) via [[AGENT-ANALYSTE-MERCURE]].

## 🔗 Source de vérité
[[../../../ANALYSTE/MERCURE/MEMOIRE.md]] (countrybook + doctrine Storm-1516, ingérés 100 %).

---

## Countrybook (savoir structuré)

### Mercure — économie & arme gazière

## Économie dirigée
Modèle d'**économie dirigée** (plans quinquennaux, entreprises d'État). **PIB ~550 Mds $** (2024) — **en déclin depuis 2013**. Exports : **pétrole/gaz 58 %**, agriculture 17 %, mines 15 %. Chômage 1,9-2,9 % (artificiel). **Dépendance Dushman** pour le high-tech. Corruption systémique des insiders Olamao.

## ⭐ Arme gazière (levier stratégique majeur)
Mercure = **quasi-monopole gaz de la région Skolkan**. **Arnland dépendante à 63 %** via pipeline Mercure/Bothnia. Menace **« tourner les robinets »** utilisée depuis 2018. Réserves : 24 Mds barils pétrole + 1,7 trillion m³ gaz (≈ 90× la conso annuelle). → chantage énergétique permanent (cf. [[REF-arnland-economie]]).

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.8 / §7. Pays : [[ENT-mercure]].

### Mercure — environnement informationnel & médias d'influence

## Contrôle intérieur
**MBC** (Mercure Broadcasting Corp) — monopole radio + TV (MBC1-3). 3 quotidiens agréés, 3 FAI agréés. **CPD** (Direction centrale de la propagande, dépend du MSS) + **SIO** (Bureau d'information de l'État) : filtrage, DPI, **VPN restreints (2019)**, « Registre unique » noir, surveillance IA reconnaissance faciale (pilote HMunik avec Dushman).

## ⭐ Médias d'influence externe
- **« Mercure Today »** — média anglophone mondial (Voice of Mercure, Radio HMunik) — vecteur de **blanchiment** (TTP-10).
- **« Meracity »** — réseau social d'État (contre la dissidence intérieure).
- **« ZubrRadio.FM »** (98.6, « la voix libre du Grand East ») — radio francophone pro-MER (front intérieur français) ; publie des **transcriptions IA** (technique de déni : « ce n'est qu'une retranscription »). 1er usage : adresse d'Olamao « Ces vies que l'Occident a brisées » (07.01.04Ei). Devenu **site-template réutilisable**.

## Posture
Olamao considère l'environnement informationnel comme **« stratégiquement décisif »** (doctrine officielle). Le MUP contrôle tous les narratifs (anti-OTAN, nostalgie Skolkan, menace extérieure). Pratique les mêmes logiques que **Storm-1516** → [[REF-storm1516]].

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.10. Pays : [[ENT-mercure]].

### Mercure — forces armées (FAM)

## Effectifs & structure
**~607 000** militaires. CINC Olamao → Conseil de sécurité → MinDéf [[ENT-junker]] → Chef EM [[ENT-numelin]]. 3 régions militaires (JCMR Nord/Centre/Sud), **3 groupes d'armées** (Bavemberg/Bohême/Milan). Terre **~225 000** (groupe chars + 2 groupes méca + 4 armées méca + 2 div. ABN + 3 bdes SOF) ; Air ~42 000 (~1 000 avions de combat, 131 bombardiers) ; Marine ~37 000. Équipement **majoritairement russe**, modernisation **Dushman**.

## Capacités
**Triade nucléaire** : ~326 ICBM (SARMAT/YARS), 12 SSBN classe Borei, 58 bombardiers lourds ; **~4 500 ogives**. **CWA opérationnel** (sarin/soman/tabun), BWA en développement (3 labs BSL-4), cyber offensif, EW/espace.

## FGF-4 = adversaire MINOTAURE 26
**IV(MER)CORPS**, cdt Lt-Gén. [[ENT-mizintsev]] (« butcher of Syria », futur FGF-L). Casting rouge complet profilé (41 TANK DIV [[ENT-pruniere]] cible 3I, 42 MECH [[ENT-koulikov]], 43 ABN [[ENT-zhukov]]…). FGF-L = [[ENT-guierassimov]] (instigateur doctrine InfoOps/déception MER).

## Milice TANTALE
Paramilitaire pro-Olamao — sécurité intérieure + **proxy externe** (Arnland, DR). Présence : diaspora MER en Arnland. Chefs locaux [[ENT-kaleva]] / [[ENT-milanov]].

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.5 / §1.7. Pays : [[ENT-mercure]].

### Mercure — régime & pouvoir

## Structure du pouvoir
**République autocratique**. **Président [[ENT-olamao]]** (depuis 2001) = chef d'État + CINC + **Conseil de sécurité (7 membres)** — pouvoir absolu. **Commissariat** = cabinet politique (parti **MUP**) — contrôle médias, ONG, internet. **Congrès du peuple** = chambre consultative (candidats contrôlés). Presse 172/180, Freedom House 31/100.

## Opposition (tolérée, marginalisée)
**MFP** ([[ENT-rossi]]) · **UPS** ([[ENT-sokolova-iouri]]) · **JS** ([[ENT-orlov-irina]]) · **UCH** ([[ENT-morozov-nikolai]]). Groupes d'influence + **TANTALE** (paramilitaire, [[ENT-werner]]). Commissions structurelles (électorale, anticorruption, judiciaire) verrouillées.

## Renseignement & justice
**MSS** ([[ENT-soloviev]], intérieur) · **FIS** ([[ENT-gusev]], extérieur) · **MIA** ([[ENT-denisov]], militaire). Justice instrumentalisée (avocate critique [[ENT-michalski]]).

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.3-1.6. Pays : [[ENT-mercure]].

### Mercure — relations internationales & infrastructure

## Relations
| Partenaire | Nature |
|---|---|
| **Arnland / DR** ([[ENT-arnland]]) | **Hostile** — rival principal ; diaspora 8 %, gaz, TANTALE, R2P |
| **Dushman** | Partenaire stratégique — équipements, 5G, ports (HSete), ferroviaire |
| **Bothnia** ([[ENT-bothnia]]) | Coopérative — allié via **SCO/SSTO** ; base **Den Helder** (bail 2027), gaz/militaire |
| **Framland** | Harmonieuse — ports Bilbao + La Corogna (accès Atlantique) |
| **OTAN** | **Hostile** — perçu comme force d'occupation (narratif anti-impérialiste) |

> Narrative canonique : *« We are not occupying. We are protecting. »* (Olamao)

## Infrastructure
**Gaz** : réseau 18 600 km → **Nord Fluss** (Bothnia + Nord Arnland + export via Den Helder) / **Sud Fluss** (Sud Arnland + Framland + GNL Gênes). Réserves ≈ 90× la conso. **Transports** : **Cenari Base Tunnel**, aéroports HMunik (hub fret Dushman) + Milan, opérateur **Skolkavia**. Nucléaire ≈ 31 % électricité.

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.11 / §7. Pays : [[ENT-mercure]].

### Mercure — société, ethnies & diaspora

## Population & ethnies
~**69,6 M**. 3 sous-ethnies **Inen** :
- **Punainen** (dominant) : Bavemberg, nord Botnie, **diaspora Arnland** — contrôle économique/financier — **Olamao = Punainen**.
- **Keltainen** : tradition navale/industrielle (Bernin, Lombmont, Tyrie).
- **Sininen** : agriculteurs (Doluskie, Saxinga…) — **marginalisés, moins loyaux à Olamao**.
Espérance 74,8 ans, fécondité 1,54 (vieillissement). Égalité F/H 53,4/100.

## ⭐ Diaspora = vecteur stratégique
**~3,4 M de Mercuriens en Arnland (8 %)** — Grand Est, PACA, Occitanie, Val-de-Loire, Alsace. **Vecteur TANTALE + prétexte R2P** pour l'intervention.

## Défis sociaux (failles)
**Féminicides 2024** (vague historique → #endfemicides, manifestations réprimées) ; endoctrinement militaro-patriotique dès la maternelle ; **loi 2019 « agents étrangers »** (calque russe) restreignant les ONG ; droits LGBTQIA+ très limités.

## 🔗 Source
[[../../ANALYSTE/MERCURE/MEMOIRE.md]] §1.9 / §5. Pays : [[ENT-mercure]].
...
| Persona | Rôle | Note |
|---|---|---|
| **Alessia Volkov** | Porte-parole du MFP | [[ENT-volkov-alessia]] |
| **Francesco Makarova** | Porte-parole de l'UPS | [[ENT-makarova-francesco]] |
| **Iouri Sokolova** | Président de l'Union pour la Souveraineté Populaire (UPS) | [[ENT-sokolova-iouri]] |
| **Irina Orlov** | Présidente de Justice et Solidarité (JS) | [[ENT-orlov-irina]] |
| **Iwona Michalski** | Avocate de droit public — critique du régime | [[ENT-michalski]] |
| **Marco Petrov** | Porte-parole de JS | [[ENT-petrov-marco]] |
| **Mikhaïl Rossi** | Président du Mercure Freedom Party (MFP) | [[ENT-rossi]] |
| **Nikolaï Morozov** | Président de l'Union pour la Concorde Civique (UCH) | [[ENT-morozov-nikolai]] |
| **Oleg Sanna** | Porte-parole de l'UCH | [[ENT-sanna-oleg]] |

---
> Source de vérité détaillée (tant que non basculé) : [`ANALYSTE/MERCURE/MEMOIRE.md`](../../ANALYSTE/MERCURE/MEMOIRE.md).
